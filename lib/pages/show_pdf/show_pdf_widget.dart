...
import 'show_pdf_model.dart';
export 'show_pdf_model.dart';

class ShowPdfWidget extends StatefulWidget {
  const ShowPdfWidget({
    Key? key,
    String? doood,
  })  : this.doood = doood ?? 'nil',
        super(key: key);
...
class _ShowPdfWidgetState extends State<ShowPdfWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShowPdfModel());
  }
